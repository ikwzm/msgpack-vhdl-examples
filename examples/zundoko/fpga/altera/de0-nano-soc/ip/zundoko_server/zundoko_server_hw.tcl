# 
#  zundoko_server "zundoko_server" v1.0
#  2016.02.04.12:06:41
# 
...
# module PTTY_AXI
# 
set_module_property DESCRIPTION                  "Zundoko Server for MessagePack-RPC"
set_module_property NAME                         zundoko_server
set_module_property VERSION                      1.0
set_module_property INTERNAL                     false
set_module_property OPAQUE_ADDRESS_MAP           true
set_module_property GROUP                        ikwzm
set_module_property AUTHOR                       "ikwzm"
set_module_property DISPLAY_NAME                 zundoko_server
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL                     Zundoko_Server
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE    false
add_fileset_file zundoko_server.vhd       VHDL PATH zundoko_server.vhd TOP_LEVEL_FILE
add_fileset_file zundoko_interface.vhd    VHDL PATH zundoko_interface.vhd
add_fileset_file zundoko_main.vhd         VHDL PATH zundoko_main.vhd
add_fileset_file tinymt32.vhd             VHDL PATH tinymt32.vhd
