...
add_verilog_file sources_1 WORK ../../../../src/main/neonlight/fib.v
...
set_property name         Fibonacci_Server_nli      [ipx::current_core]
set_property display_name Fibonacci_Server_nli_v1_0 [ipx::current_core]
set_property description  Fibonacci_Server_nli_v1_0 [ipx::current_core]
#
