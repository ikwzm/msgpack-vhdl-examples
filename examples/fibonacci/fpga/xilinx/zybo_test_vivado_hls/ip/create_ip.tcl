...
add_vhdl_file sources_1 WORK ../hls/fib_prj/solution1/syn/vhdl/fib.vhd
...
set_property name         Fibonacci_Server_hls      [ipx::current_core]
set_property display_name Fibonacci_Server_hls_v1_0 [ipx::current_core]
set_property description  Fibonacci_Server_hls_v1_0 [ipx::current_core]
#
