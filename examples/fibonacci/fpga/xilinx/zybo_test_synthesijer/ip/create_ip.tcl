...
set_property name         Fibonacci_Server_sjr      [ipx::current_core]
set_property display_name Fibonacci_Server_sjr_v1_0 [ipx::current_core]
set_property description  Fibonacci_Server_sjr_v1_0 [ipx::current_core]
#
