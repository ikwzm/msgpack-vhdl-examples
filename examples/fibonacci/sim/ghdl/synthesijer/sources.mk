...
Fib.o : ../../../src/main/synthesijer/Fib.vhd 
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/main/synthesijer/Fib.vhd

fib_interface.o : ../../../src/main/synthesijer/fib_interface.vhd msgpack_rpc.o msgpack_object.o msgpack_rpc_components.o msgpack_rpc_method_main_with_param.o msgpack_rpc_method_set_param_integer.o msgpack_rpc_method_return_integer.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/main/synthesijer/fib_interface.vhd

fibonacci_server.o : ../../../src/main/synthesijer/fibonacci_server.vhd msgpack_object.o msgpack_rpc.o msgpack_rpc_components.o msgpack_rpc_server.o fib_interface.o Fib.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/main/synthesijer/fibonacci_server.vhd
