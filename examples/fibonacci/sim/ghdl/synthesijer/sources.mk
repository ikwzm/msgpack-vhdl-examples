...
fib_interface.o : ../../../src/main/synthesijer/fib_interface.vhd msgpack_object.o msgpack_rpc.o msgpack_rpc_components.o msgpack_object_components.o msgpack_rpc_server.o msgpack_rpc_method_main_with_param.o msgpack_object_store_integer_register.o msgpack_rpc_method_return_integer.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/main/synthesijer/fib_interface.vhd

fibonacci_server.o : ../../../src/main/synthesijer/fibonacci_server.vhd fib_interface.o Fib.o
