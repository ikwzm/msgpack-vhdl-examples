...
Fibonacci_Interface.o : ../../../src/main/vhdl/Fibonacci_Interface.vhd msgpack_object.o msgpack_rpc.o msgpack_rpc_components.o msgpack_object_components.o msgpack_rpc_server.o msgpack_rpc_method_main_with_param.o msgpack_object_store_integer_register.o msgpack_rpc_method_return_integer.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/main/vhdl/Fibonacci_Interface.vhd

fib.o : ../../../src/main/vhdl/fib.vhd 
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/main/vhdl/fib.vhd

Fibonacci_Server.o : ../../../src/main/vhdl/Fibonacci_Server.vhd Fibonacci_Interface.o fib.o
