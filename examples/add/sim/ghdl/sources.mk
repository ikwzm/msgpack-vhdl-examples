...
ADD.o : ../../src/main/synthesijer/ADD.vhd 
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../src/main/synthesijer/ADD.vhd
...
add_server.o : ../../src/main/vhdl/add_server.vhd msgpack_object.o msgpack_rpc.o msgpack_rpc_components.o msgpack_rpc_server.o add_interface.o ADD.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../src/main/vhdl/add_server.vhd

test_bench.o : ../../src/test/vhdl/test_bench.vhd add_server.o
